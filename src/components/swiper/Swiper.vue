<template>
  <div class="vi-swiper-container"
    ...
    <div class="vi-swiper-wrapper"
         :style="styleWrap">
      <slot />
    </div>
    <div class="vi-direction-nav"
         v-if="directionNav">
      <a href="javascript:;"
         class="vi-swiper-prev"
         @click="_directionNavilick(-1)"></a>
      <a href="javascript:;"
         class="vi-swiper-next"
         @click="_directionNavilick(1)"></a>
    </div>
    <div class="vi-control-nav"
         v-if="controlNav">
      <a href="javascript:;"
         v-for="(item,index) in swipes"
         :class="{'vi-control-nav-active':index===current}"
         :key="index"
         @click="_controlNavilick(index)"></a>
    </div>
  </div>
</template>
<script>
